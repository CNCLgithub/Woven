...
for i in $(seq 1 $total_len); do
  ...
  if [ -f out/result_${cur_cloth_scene_mass_bs}_?_${match[$cur_idx]}_${match_model_idx[$cur_idx]}.h5* ]; then
    echo match_1
  elif [ -f out/result_${cur_cloth_scene_mass_bs}_??_${match[$cur_idx]}_${match_model_idx[$cur_idx]}.h5* ]; then
    echo match_2
  elif [ -f out/result_${cur_cloth_scene_mass_bs}_???_${match[$cur_idx]}_${match_model_idx[$cur_idx]}.h5* ]; then
    echo match_3
  else
    echo match_0
    echo out/result_${cur_cloth_scene_mass_bs}_???_${match[$cur_idx]}_${match_model_idx[$cur_idx]}.h5*
  ...
  if [ -f out/result_${cur_cloth_scene_mass_bs}_?_${distract[$cur_idx]}_${distract_model_idx[$cur_idx]}.h5* ]; then
    echo distract_1
  elif [ -f out/result_${cur_cloth_scene_mass_bs}_??_${distract[$cur_idx]}_${distract_model_idx[$cur_idx]}.h5* ]; then
    echo distract_2
  elif [ -f out/result_${cur_cloth_scene_mass_bs}_???_${distract[$cur_idx]}_${distract_model_idx[$cur_idx]}.h5* ]; then
    echo distract_3
  else
    echo distract_0
    echo out/result_${cur_cloth_scene_mass_bs}_???_${distract[$cur_idx]}_${distract_model_idx[$cur_idx]}.h5*
    ./run.sh julia src/exp_basic.jl ${scene_idx_dicts[$cur_scene]}/${cur_cloth_scene_mass_bs} \
                                ${exp_cond} \
