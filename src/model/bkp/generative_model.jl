...
# get_var_value_mass(rw_var::Float64, var_small::Float64, var_large::Float64) = get_var_value(rw_var, var_small, var_large)
# get_var_value_stiffness(rw_var::Float64, var_small::Float64, var_large::Float64) = get_var_value(rw_var, var_small, var_large)
